package com.example.andemo.ui.mediaextractorandmediamuxer;
...
public class MediaExtractorAndMuxerActivity extends AppCompatActivity {

    private static final String SDCARD_PATH = "/sdcard/Android/data/com.example.andemo/files/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_media_extractor_and_muxer);
        // 获取权限
    ...
    private void extractorVideo() {
        ...
        try {
            // 设置数据源
            mediaExtractor.setDataSource(SDCARD_PATH + "/ann.mp4");
            // 数据源的轨道数
